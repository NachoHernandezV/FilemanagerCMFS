...
<table width="100%" border="0px" align="center">
	...
	date_default_timezone_set('America/Monterrey');
		...
		$UsuarioActual=$_SESSION['usuarioname'];
		$Areas=$_POST[Areas];
		$_SESSION['areas2']=$_POST[Areas];
		$Misarchivos=$_POST[MisArchivos];
		
		if($Misarchivos == "Mis Archivos" or $_SESSION['areas2']=="")
		{
		...
		{	
			...
			//$consultaarchivos="SELECT a.idcarpeta,a.carpeta,a.carpetaMadre FROM carpetas a WHERE a.carpetaMadre='Cero' and a.departamento='".$_SESSION['Areas']."'";
		...
		{	
			...
			//CREAR SUBCARPETAS
				//$consultaarchivos="SELECT a.idcarpeta,a.carpeta,a.carpetaMadre FROM carpetas a, departamentos d WHERE a.iddepartamento=d.iddepartamento and a.carpetaMadre='Cero' and d.departamento='".$_SESSION['Areas']."'";
	...
	else
	{
		...
		echo "<td align='center' colspan='2'>";
		echo "<FONT size='3' FACE='small fonts' color='#3B170B'>Creador</FONT>";
		echo "</td>";
		
		echo "<td align='center' colspan='2'>";
		echo "<FONT size='3' FACE='small fonts' color='#3B170B'></FONT>";
		echo "</td>";
		
		echo "<td align='center' colspan='3'>";
		echo "<FONT size='3' FACE='small fonts' color='#3B170B'>Acciones&nbsp&nbsp&nbsp&nbsp&nbsp</FONT>";
		echo "</td>";
	}
		...
		if( $_POST['codigoarchivocar']>0 or $_POST['Actualizar']=='Actualizar')
		{
			...
			if($Misarchivos=="Mis Archivos")
			{
				...
				/////////////////   PARA OBTENER DEPARTAMENTO JUNTO PARA VER ARCHIVOS DE OTRAS AREAS
					$consultaarchivos4="SELECT * FROM departamentos WHERE $departjuntoonormal='".$_SESSION['Areas']."'";
					$re4=mysqli_query($con,$consultaarchivos4);
				...
				$consultaarchivos="SELECT a.idarchivo,a.nombrearchivo,a.nombrereal,a.fecha,a.creador FROM permisos p, archivos a, departamentos d WHERE a.idarchivo=p.idarchivo and d.iddepartamento=a.iddepartamento and d.".$departjuntoonormal."='".$_SESSION['Areas']."' and p.".$nombrearchivoreal2."='si' and a.idcarpeta='".$_POST[codigoarchivocar]."'";
				$re=mysqli_query($con,$consultaarchivos);
							...
							echo "</td>";
								...
								if($extarchivo2 == "pdf" or $extarchivo2 == "jpg" or $extarchivo2 == "png" or $extarchivo2 == "bmp" or $extarchivo2 == "html" or $extarchivo2 == "htm")
								{
									...
									echo "<form name='formulariof' method='post' target='_blank' action='verpdf.php'>";
										...
										echo  "<input type='hidden' name='usuario' value='".$_SESSION['usuarioname']."' />";
										echo "</td>";
								...
								else
								{
									...
									echo "<form name='formulariof' method='post' target='_blank' action='descarga.php'>";
